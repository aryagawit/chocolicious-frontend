...
const queryRes = await fetch(`${baseURL}/api/admin/queries`, {
          ...
          queries.map((q) => (
            <tr key={q.id}>
              ...
              <td>
                ...
                <small className="date-tag">{q.req_date || "No date set"}</small>
              </td>
            </tr>
          ))
        ) : (
          <tr><td colSpan="4" className="empty-msg">No customer messages yet! ✉️</td></tr>
        )}
      </tbody>
    </table>
  ) : activeTab === "orders" ? (
